...
const suppliers = [
  ...
  { name: 'Lasec', contactPerson: null, email: null, phone: null, address: null },
  ...
  { name: 'Anatech', contactPerson: null, email: null, phone: null, address: null },
  ...
  try {
    ...
    for (const supplier of suppliers) {
      ...
      if (existing.rows.length > 0) {
        console.log(`Skipping ${supplier.name} - already exists`)
        skipped++
        continue
      }
